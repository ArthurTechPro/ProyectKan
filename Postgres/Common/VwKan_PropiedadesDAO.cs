...
{
    [Serializable()]
    public class VwKan_PropiedadesDAO : DataSet
    {
        //Constantes

        /// <summary>Constante con el nombre de la tabla VwKan_Propiedades</summary>
        public const string VWKAN_PROPIEDADES_TABLA = "VwKan_Propiedades";
        ...
        /// <summary>Constante con el nombre del campo tipopropiedad</summary>
        ...
        private void BuildDataTables()
        {
            ...
            table = new DataTable(VwKan_PropiedadesDAO.VWKAN_PROPIEDADES_TABLA);
