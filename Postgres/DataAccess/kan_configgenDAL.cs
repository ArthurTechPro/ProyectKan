...
namespace ProjectKAN.DAL
{
   public class kan_configgenDAL
   {
      ...
      private NpgsqlCommand GetDelete()
      {
         ...
         sqlCmd.Parameters.Add(new NpgsqlParameter(IDCONFIGGEN_PARAM, NpgsqlDbType.Integer));
         return sqlCmd;
      }
      ...
      private NpgsqlCommand GetInsert()
      {
         ...
         sqlCmd.Parameters.Add(new NpgsqlParameter(CONTANTE_PARAM, NpgsqlDbType.Varchar));
         sqlCmd.Parameters[CONTANTE_PARAM].SourceColumn = kan_configgenDAO.CONTANTE_CAMPO;

         sqlCmd.Parameters.Add(new NpgsqlParameter(VARIABLE_PARAM, NpgsqlDbType.Varchar));
