...
namespace ProjectKAN.BLL
{
    public class kan_parametrosBLL
    {
        ...
        public void Insert(string idcomando, string nomcomando, string nomparametro, string tipodato, string tipodatosql, string tamano, string direccion)
        {
            kan_parametrosDAL dataDAL = new kan_parametrosDAL();
            ...
            dr[kan_parametrosDAO.TIPODATOSQL_CAMPO] = tipodatosql;
            if (idcomando != "")
        ...
        public void Update(string idparametro, string idcomando, string nomcomando, string nomparametro, string tipodato, string tipodatosql, string tamano, string direccion)
        {
            kan_parametrosDAL dataDAL = new kan_parametrosDAL();
            dataDAL.Update(System.Int32.Parse(idparametro), System.Int32.Parse(idcomando), nomcomando, nomparametro, tipodato, tipodatosql, System.Int32.Parse(tamano), System.Int16.Parse(direccion));
        }
