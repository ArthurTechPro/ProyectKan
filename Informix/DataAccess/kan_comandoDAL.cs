...
namespace ProjectKAN.DAL
{
    ...
    public class kan_comandoDAL
    {
        ...
        private string sqlDelete = "DELETE FROM kan_comando WHERE idcoman = ?";
        private string sqlInsert = "INSERT INTO kan_comando (idcoman, comando) VALUES ( ?, ?)";
        private string sqlSelectALL = "SELECT idcoman, comando FROM kan_comando";
        private string sqlSelectID = "SELECT idcoman, comando FROM kan_comando WHERE idcoman = ?";
        private string sqlUpdate = "UPDATE kan_comando SET comando = ? WHERE idcoman = ?";
