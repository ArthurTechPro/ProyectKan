...
namespace ProjectKAN.DAL
{
   ...
   public class VwKan_PropiedadesDAL : IDisposable
   {
      ...
      private string sqlSelectID = "SELECT nomproject, namespaceproject, nameproject, idpropiedad, idprojectp, iddata, tipopropiedad, nombre, padre, creaselect, creainsert, creadelete, creaupdate FROM VwKan_Propiedades WHERE nombre = ?";
      ...
      public VwKan_PropiedadesDAL()
      {
         ...
         sqlDA.TableMappings.Add(VwKan_PropiedadesDAO.VWKAN_PROPIEDADES_TABLA, VwKan_PropiedadesDAO.VWKAN_PROPIEDADES_TABLA);
      }
