...
namespace ProjectKAN.DAL
{
    ...
    public class kan_comandoDAL
    {
        ...
        private string sqlUpdate = "UPDATE kan_comando SET idcoman = @idcoman, comando = @comando WHERE idcoman = @idcoman";
        ...
        private SqlCommand GetInsert()
        {
            ...
            sqlCmd.Parameters.Add(new SqlParameter(COMANDO_PARAM, SqlDbType.VarChar, 60));
